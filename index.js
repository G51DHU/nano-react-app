            ...
            rl.question('      - Keywords? : ', function (package_keywords) {
                ...
                if (validationAnswer["validForNewPackages"] === true){
                    ...
                    gitClone(template_github_link, `${working_dir_path}/${project_name}`, function (err) {
                        err ? spinner_download.fail('Template download error.') : packageInstall(path =`${working_dir_path}/${project_name}`, project_name , chosen_package_manager, spinner_download, spinner_install, package_description)
                    })
